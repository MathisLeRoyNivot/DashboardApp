 ...
 */
final class Version20181220123627 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE main_stats (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, stat_name VARCHAR(255) NOT NULL, value DOUBLE PRECISION NOT NULL)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE main_stats');
        $this->addSql('DROP INDEX UNIQ_3C6AFA536E1ECFCD');
        $this->addSql('CREATE TEMPORARY TABLE __temp__marks AS SELECT id, id_student_id, mark_dev, mark_network, mark_bdd FROM marks');
        $this->addSql('DROP TABLE marks');
